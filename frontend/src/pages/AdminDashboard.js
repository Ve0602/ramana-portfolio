...
const TABS = ['Dashboard','Brand Settings','Login Page','Home Page','Products','Services','Referrals','Resume','Freelance','Portfolio','Reviews','Users'];
const ICONS = { Dashboard:'📊', 'Brand Settings':'🎨', 'Login Page':'🔐', 'Home Page':'🏠', Products:'🛍️', Services:'⚙️', Referrals:'🔗', Resume:'📄', Freelance:'💼', Portfolio:'📝', Reviews:'⭐', Users:'👥' };
